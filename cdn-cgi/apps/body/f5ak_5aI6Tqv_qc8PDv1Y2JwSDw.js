;if(CloudflareApps.matchPage(CloudflareApps.installs['FxIPr55TH7tU'].URLPatterns)){(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId]){return installedModules[moduleId].exports;}
...
({"./src/index.js":(function(module,exports,__webpack_require__){"use strict";var _styles=__webpack_require__("./src/styles.css");var _styles2=_interopRequireDefault(_styles);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
function init(){if(!window.addEventListener)return;var options=CloudflareApps.installs['FxIPr55TH7tU'].options;var element=void 0;var style=document.createElement('style')
function updateElement(){var containerMethod="prepend"
var cookieMessage=options.message;if(options.position=="bottom"){containerMethod="append"}
element=CloudflareApps.createElement({selector:'body',method:containerMethod},element)
element.setAttribute("app","cookie_banner");element.setAttribute('data-position',options.position);cookieConsent(element,cookieMessage);element.style.zIndex=getMaxZIndex()+1
updateStyle();element.appendChild(style);}
function updateStyle(){style.innerHTML='cloudflare-app[app="cookie_banner"] \
                        { background-color: '+options.backgroundColor+'; \
                        color: '+options.textColor+'; } \
                      cloudflare-app[app="cookie_banner"] cookieConsentContainer cookieButton > a \
                        { background: '+options.buttonColor+'; \
                          color: '+options.buttonTextColor+'; } '}
function getMaxZIndex(){var elements=document.getElementsByTagName('*')
var max=0
...
return max}
window.CloudflareApps.installs['FxIPr55TH7tU'].scope={clearCookiePreview:function clearCookiePreview(nextOptions){clearCookie();updateElement();},setOptions:function setOptions(nextOptions){options=nextOptions;updateElement();}};if(document.readyState==="loading"){document.addEventListener("DOMContentLoaded",updateElement);}else{updateElement();}}
init();}),"./src/styles.css":(function(module,exports,__webpack_require__){module.exports=__webpack_require__.p+"styles.css";})});};if(CloudflareApps.matchPage(CloudflareApps.installs['RmxAZsP38RrK'].URLPatterns)){(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId]){return installedModules[moduleId].exports;}
var module=installedModules[moduleId]={i:moduleId,l:false,exports:{}};modules[moduleId].call(module.exports,module,module.exports,__webpack_require__);module.l=true;return module.exports;}
...
var options=CloudflareApps.installs['RmxAZsP38RrK'].options
var element=void 0
...
window.CloudflareApps.installs['RmxAZsP38RrK'].scope={updateColors:function updateColors(nextOptions){options=nextOptions
...
setPosition()}}})()})]);};(function(){try{var link=document.createElement('link');link.rel='stylesheet';link.href='data:text/css;charset=utf-8;base64,';document.getElementsByTagName('head')[0].appendChild(link);}catch(e){}})();